...
JVM_ARGS="-Xms512m -Xmx2048m" jmeter -n -X -Jclient.rmi.localport=7000 -Jserver.rmi.ssl.disable=true -R slave-1 -Jjmeter.save.saveservice.subresults=false -t /${scriptname}.jmx -f -l /${scriptname}.jtl -e -o /results/output/"`date`" 2>&1
